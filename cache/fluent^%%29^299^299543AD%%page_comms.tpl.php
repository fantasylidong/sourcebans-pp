<?php /* Smarty version 2.6.31, created on 2022-02-22 12:52:13
         compiled from page_comms.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlspecialchars', 'page_comms.tpl', 36, false),array('modifier', 'escape', 'page_comms.tpl', 68, false),array('modifier', 'stripslashes', 'page_comms.tpl', 68, false),)), $this); ?>
                    ...
                    <div class="padding flex flex-jc:start">
                      <ul class="ban_action">
                        <?php if (( $this->_tpl_vars['ban']['unbanned'] == false && $this->_tpl_vars['ban']['view_unban'] )): ?>
                          <li class="button button-success"><?php echo $this->_tpl_vars['ban']['unban_link']; ?>
</li>
                        <?php endif; ?>
