<?php /* Smarty version 2.6.31, created on 2022-02-19 06:34:52
        ...
        <div class="padding">
            ...
            <form action="index.php?p=protest" method="post">
                ...
                <div id="steam.row" class="margin-bottom:half">
                    ...
                    <input type="text" id="SteamID" name="SteamID" size="40" maxlength="64" value="<?php echo $this->_tpl_vars['steam_id']; ?>
"
                ...
                <div id="ip.row" class="margin-bottom:half" style="display: none;">
                    ...
                    <input type="text" id="Ip" name="IP" size="40" maxlength="64" value="<?php echo $this->_tpl_vars['ip']; ?>
"
                        class="form-input form-full" />
                </div>
...
"
                ...
                <div class="margin-bottom:half">
                    ...
                    <textarea id="BanReason" name="BanReason" cols="30" rows="5"
                        class="form-text form-full input"><?php echo $this->_tpl_vars['reason']; ?>
</textarea>
                </div>
...
"
                ...
                <div class="flex">
                    <?php echo smarty_function_sb_button(array('text' => 'Submit','class' => "button button-primary flex:11",'id' => 'alogin','submit' => true), $this);?>
