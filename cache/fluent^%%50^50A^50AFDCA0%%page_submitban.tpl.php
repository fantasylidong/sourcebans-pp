<?php /* Smarty version 2.6.31, created on 2022-02-21 20:35:49
         compiled from page_submitban.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'page_submitban.tpl', 112, false),)), $this); ?>
        ...
        <div class="padding">
            ...
            <form action="index.php?p=submit" method="post" enctype="multipart/form-data">
                ...
                <div class="margin-bottom:half">
                    ...
                    <input type="text" id="SteamID" name="SteamID" size="40" maxlength="64" value="<?php echo $this->_tpl_vars['STEAMID']; ?>
"
                ...
                <div class="margin-bottom:half">
                    ...
                    <input type="text" id="BanIP" name="BanIP" size="40" maxlength="64" value="<?php echo $this->_tpl_vars['ban_ip']; ?>
"
                        class="form-input form-full" />
                </div>
                ...
                <div class="margin-bottom:half">
                    ...
                    <input type="text" id="PlayerName" size="40" maxlength="70" name="PlayerName" value="<?php echo $this->_tpl_vars['player_name']; ?>
"
                        class="form-input form-full" />
                </div>
                ...
                <div class="margin-bottom:half">
                    ...
                    <textarea id="BanReason" name="BanReason" class="form-text form-full"><?php echo $this->_tpl_vars['ban_reason']; ?>
</textarea>
                </div>
                ...
                <div class="margin-bottom:half">
                    ...
                    <input type="text" id="SubmitName" size="40" maxlength="70" name="SubmitName"
                        value="<?php echo $this->_tpl_vars['subplayer_name']; ?>
" class="form-input form-full" />
                </div>
                ...
                <div class="margin-bottom:half">
                    ...
                    <input type="text" id="EmailAddr" size="40" maxlength="70" name="EmailAddr" value="<?php echo $this->_tpl_vars['player_email']; ?>
"
                        class="form-input form-full" />
                </div>
...
" <?php if ($this->_tpl_vars['server_selected'] == $this->_tpl_vars['server']['sid']): ?>selected<?php endif; ?>>
                                <?php echo $this->_tpl_vars['server']['hostname']; ?>
</option>
                ...
                <div class="flex">
                    <?php echo smarty_function_sb_button(array('text' => 'Submit','class' => "button button-primary flex:11",'id' => 'save','submit' => true), $this);?>
