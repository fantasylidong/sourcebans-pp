...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'box_admin_comms_search.tpl', 227, false),)), $this); ?>
...
:<?php echo $this->_tpl_vars['server']['port']; ?>
                                    ...
                                    <div class="flex">
                                        <?php echo smarty_function_sb_button(array('text' => 'Search','onclick' => "search_blocks();",'class' => "button button-primary flex:11",'id' => 'searchbtn','submit' => false), $this);?>
