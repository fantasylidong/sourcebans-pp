<?php /* Smarty version 2.6.31, created on 2022-02-22 12:52:00
         compiled from page_bans.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlspecialchars', 'page_bans.tpl', 36, false),array('modifier', 'escape', 'page_bans.tpl', 84, false),array('modifier', 'stripslashes', 'page_bans.tpl', 84, false),)), $this); ?>
          ...
          <thead>
            <tr>
              <?php if ($this->_tpl_vars['view_bans']): ?>
                <th class="text:left">
                  <input type="checkbox" title="Select All" name="tickswitch" id="tickswitch" onclick="TickSelectAll()"
                    class="form-check" />
                </th>
              <?php endif; ?>
              <th>MOD/Country</th>
...
" target="_blank"
                        ...
                        <li>
                          ...
                          <?php else: ?>
                            <span><?php echo $this->_tpl_vars['ban']['banlog']; ?>
</span>
                          <?php endif; ?>
                        </li>
                      </ul>
